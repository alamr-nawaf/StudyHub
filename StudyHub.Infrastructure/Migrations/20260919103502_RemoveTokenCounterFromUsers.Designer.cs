...
namespace StudyHub.Infrastructure.Migrations
{
    ...
    [Migration("20260919103502_RemoveTokenCounterFromUsers")]
    partial class RemoveTokenCounterFromUsers
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Items", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Item_PriorityValue", "\"Priority\" IS NULL OR \"Priority\" BETWEEN 0 AND 2");

                            t.HasCheckConstraint("CK_Item_RootDepth", "(\"ParentItemId\" IS NULL) = (\"Depth\" = 0)");

                            t.HasCheckConstraint("CK_Item_StatusValue", "\"Status\" IS NULL OR \"Status\" BETWEEN 0 AND 2");
